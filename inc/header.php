<nav class="navbar navbar-expand-lg navbar-light bg-white pg-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">NearMe</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link me-2" href="#">Hostels</a>
                </li>
                <li class="nav-item">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form>
                ...
                <div class="modal-body">
                    <span class="badge rounded-pill bg-light text-dark mv-3 text-wrap lh-base">
                        Note: Your details must match with your ID (Aadhar Card, Passport, etc.). This will be used for your check-in details.
                    </span> 
                    <div class="container-fluid">
                        <div class="row">
